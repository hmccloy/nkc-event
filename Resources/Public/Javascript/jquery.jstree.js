	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:#626262; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' +
...
(function ($) {
	...
	$(function() {
		var css_string = '' + 
			...
			'#jstree-marker { padding:0; margin:0; font-size:12px; overflow:hidden; height:12px; width:8px; position:absolute; top:-30px; z-index:10001; background-repeat:no-repeat; display:none; background-color:transparent; text-shadow:1px 1px 1px white; color:#626262; line-height:10px; } ' +
